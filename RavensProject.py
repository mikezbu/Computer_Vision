...
def solve():
    ...
    with open("AgentAnswers.csv","w") as results:     # Results will be written to AgentAnswers.csv.
                                                        # Note that each run of the program will overwrite the previous results.
                                                        # Do not write anything else to AgentAnswers.csv during execution of the program.
